 <!DOCTYPE html>
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($_FILES["image_data"]["tmp_name"], $targetFile)) {
      echo "<div class='alert alert-success'>La imagen se ha guardado correctamente.
            <a href='recorte_atras.php'>Subir Imagen de Atras</a></div>";
    } else {
  ...
  ?>
    <h1>Imagen De Frente</h1>
    <div class="container">
      <div class="group">
        <form id="upload-form" method="post" action="index.php" enctype="multipart/form-data" onsubmit="return validateForm()">
    ...
    <script>
      ...
      saveBtn.addEventListener('click', () => {
        ...
        croppedCanvas.toBlob((blob) => {
          ...
          const croppedFile = new File([blob], 'imagen_frente.jpg', {
            type: 'image/jpeg'
          });
